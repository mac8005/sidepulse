...
Request (Massimo, 2026-09-18): best-experience iPhone Duo support, tested in the Duo simulator, screenshots of design VARIANTS per screen sent for approval before anything is finalised. IMPLEMENTED 2026-09-19 on `mac8005/iphone-duo`; screenshots in `/Volumes/MacMiniData/Developer/duo-shots/sidepulse/`.
