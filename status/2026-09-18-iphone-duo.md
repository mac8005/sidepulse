...
- BLOCKED: the `iPhone Duo` device type needs the iOS 27.1 simulator runtime (7.85 GB download, ~15–17 GB on the internal disk incl. dyld cache and device data; 15 GiB free on 2026-09-18). Waiting for Massimo to free space. No Duo screenshot exists yet; every layout statement below is a prediction.
...
## Design variants to screenshot once the simulator works
